...
import Frame from '../../../node_modules/flowbite-svelte/dist/utils/Frame.svelte';
import { createEventDispatcher, type ComponentProps } from 'svelte';
import CloseButton from '../../../node_modules/flowbite-svelte/dist/utils/CloseButton.svelte';
import focusTrap from '../../../node_modules/flowbite-svelte/dist/utils/focusTrap';
import type { Dismissable, SizeType } from '../../../node_modules/flowbite-svelte/dist/types';
import type { ModalPlacementType } from '../../../node_modules/flowbite-svelte/dist/types';
...
export let focusTrapEnabled: $$Props['focusTrapEnabled'] = true;
...
$: {
    if(focusTrapEnabled) trap = focusTrap(el);
    else if(trap) trap?.destroy?.();
}
...
<div bind:this={el} on:keydown={handleKeys} on:wheel|preventDefault|nonpassive use:prepareFocus on:click={onAutoClose} on:mousedown={onOutsideClose} class={dialogCls} tabindex="-1" aria-modal="true" role="dialog">
