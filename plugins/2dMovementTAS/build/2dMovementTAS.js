...
/* src\ui\AnglePicker.svelte generated by Svelte v4.2.18 */
...
/* src\ui\UI.svelte generated by Svelte v4.2.18 */

function add_css$1(target) {
	append_styles(target, "svelte-f9vhnq", ".UI.svelte-f9vhnq.svelte-f9vhnq{position:absolute;background-color:rgba(255, 255, 255, 0.6);top:0;left:0;height:100%;z-index:9999999}.controls.svelte-f9vhnq.svelte-f9vhnq{height:50px;display:flex;align-items:center;justify-content:center;gap:5px}table.svelte-f9vhnq.svelte-f9vhnq{min-width:100%}tr.svelte-f9vhnq.svelte-f9vhnq{height:22px}td.dragged.svelte-f9vhnq.svelte-f9vhnq{background-color:rgba(0, 138, 197, 0.5) !important}tr.active.svelte-f9vhnq.svelte-f9vhnq{background-color:rgba(0, 138, 197, 0.892) !important}tr.svelte-f9vhnq.svelte-f9vhnq:nth-child(even){background-color:rgba(0, 0, 0, 0.1)}th.svelte-f9vhnq.svelte-f9vhnq:first-child,td.svelte-f9vhnq.svelte-f9vhnq:first-child{width:100px}input[type=\"checkbox\"].disabled.svelte-f9vhnq.svelte-f9vhnq,input[type=\"checkbox\"].svelte-f9vhnq.svelte-f9vhnq:disabled{opacity:0.5}th.svelte-f9vhnq.svelte-f9vhnq,td.svelte-f9vhnq.svelte-f9vhnq{height:22px;width:60px;text-align:center;-webkit-user-select:none;-moz-user-select:none;user-select:none}.angle.svelte-f9vhnq.svelte-f9vhnq{width:130px;padding:0 10px;display:flex;align-items:center;gap:5px;cursor:pointer}.angle.svelte-f9vhnq .number.svelte-f9vhnq{flex-grow:1;display:flex;align-items:center;gap:5px}.drag.svelte-f9vhnq.svelte-f9vhnq{cursor:ns-resize}");
}
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			div2.textContent = "↕";
			t11 = space();
			attr(td0, "class", "frame svelte-f9vhnq");
			attr(input0, "type", "checkbox");
			attr(input0, "class", "svelte-f9vhnq");
			toggle_class(input0, "disabled", /*answerDisabled*/ ctx[50]);
			attr(td1, "class", "svelte-f9vhnq");
			attr(input1, "type", "checkbox");
			attr(input1, "class", "svelte-f9vhnq");
			toggle_class(input1, "disabled", /*purchaseDisabled*/ ctx[51]);
			attr(td2, "class", "svelte-f9vhnq");
			attr(input2, "type", "checkbox");
			attr(input2, "class", "svelte-f9vhnq");
			toggle_class(input2, "disabled", /*moveDisabled*/ ctx[52]);
			attr(td3, "class", "svelte-f9vhnq");
			set_style(div0, "transform", "rotate(" + (/*frames*/ ctx[0][/*index*/ ctx[49]].angle + 90) + "deg)");
			attr(div1, "class", "number svelte-f9vhnq");
			attr(div2, "class", "drag svelte-f9vhnq");
			attr(td4, "class", "angle svelte-f9vhnq");
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			table = element("table");
			tr = element("tr");
			tr.innerHTML = `<th class="svelte-f9vhnq">Frame #</th> <th class="svelte-f9vhnq">Answer</th> <th class="svelte-f9vhnq">Purchase</th> <th class="svelte-f9vhnq">Move</th> <th class="svelte-f9vhnq">Angle</th>`;
			t19 = space();
			...
			attr(div0, "class", "controls svelte-f9vhnq");
			attr(tr, "class", "svelte-f9vhnq");
			attr(table, "class", "svelte-f9vhnq");
			attr(div1, "class", "UI svelte-f9vhnq");
		},
		m(target, anchor) {
...
/* src\ui\Start.svelte generated by Svelte v4.2.18 */
