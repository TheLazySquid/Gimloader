...
class FullGame extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { category: 4 });
	}
}
...
class ILSettings extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { category: 0, summit: 5 }, add_css);
	}
}
...
// (9:4) {#each categories as category}
...
// (16:4) {#each splitNames as split, i}
