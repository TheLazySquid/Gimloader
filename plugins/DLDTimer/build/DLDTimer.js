...
// (29:0) {#if category !== "Current Patch"}
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const change_handler = e => {
		if (!e.currentTarget.value) {
			$$invalidate(2, noPreboostsPb = null);
			return;
		}
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			t13 = space();
			div7 = element("div");
			div7.textContent = `This requires that you have the InputRecorder plugin installed and enabled${/*hasInputRecorder*/ ctx[6] ? "" : " (which you don't)"}`;
		...
		m(target, anchor) {
			...
			append(div6, input5);
			input5.checked = /*autoRecord*/ ctx[5];
			append(div6, t12);
			...
			if (!mounted) {
				dispose = [
					...
					listen(input4, "change", /*input4_change_handler*/ ctx[12]),
					listen(input5, "change", /*input5_change_handler*/ ctx[13])
				];
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function input5_change_handler() {
		...
		$$invalidate(5, autoRecord);
	}

	$$self.$$set = $$props => {
		if ('autosplitter' in $$props) $$invalidate(7, autosplitter = $$props.autosplitter);
	};
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*autoRecord*/ 32) {
			GL.storage.setValue("DLD Timer", "autoRecord", autoRecord);
		}

		if ($$self.$$.dirty & /*autostartILs*/ 16) {
			$$invalidate(7, autosplitter.autostartILs = autostartILs, autosplitter);
		}

		if ($$self.$$.dirty & /*autoRecord*/ 32) {
			$$invalidate(7, autosplitter.autoRecord = autoRecord, autosplitter);
		}
	};
...
class Toggles extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { autosplitter: 7 }, add_css);
	}
}
