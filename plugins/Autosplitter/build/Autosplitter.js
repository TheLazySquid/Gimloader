...
class FullGame extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$6, create_fragment$6, safe_not_equal, { splits: 1, data: 0, category: 2 });
	}
}
...
class ILSettings extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$5, create_fragment$5, safe_not_equal, { data: 0, category: 1, summit: 4 }, add_css$3);
	}
}
...
function add_css$2(target) {
	append_styles(target, "svelte-17sfzol", ".row.svelte-17sfzol{display:flex;align-items:center;gap:10px}input.svelte-17sfzol{width:20px;height:20px}.note.svelte-17sfzol{font-size:0.7em;color:gray}.error.svelte-17sfzol{color:red}");
}
...
function create_fragment$4(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "row svelte-17sfzol");
			attr(input0, "type", "checkbox");
			attr(input0, "class", "svelte-17sfzol");
			attr(div1, "class", "row svelte-17sfzol");
			attr(input1, "type", "checkbox");
			attr(input1, "class", "svelte-17sfzol");
			attr(div2, "class", "row svelte-17sfzol");
			attr(input2, "type", "checkbox");
			attr(input2, "class", "svelte-17sfzol");
			attr(div3, "class", "row svelte-17sfzol");
			attr(input3, "type", "checkbox");
			attr(input3, "class", "svelte-17sfzol");
			attr(div4, "class", "row svelte-17sfzol");
			attr(input4, "type", "checkbox");
			attr(input4, "class", "svelte-17sfzol");
			attr(div5, "class", "row svelte-17sfzol");
			attr(input5, "type", "checkbox");
			attr(input5, "class", "svelte-17sfzol");
			attr(div6, "class", "row svelte-17sfzol");
			attr(div7, "class", "note svelte-17sfzol");
			attr(input6, "type", "checkbox");
			attr(input6, "class", "svelte-17sfzol");
			attr(div8, "class", "row svelte-17sfzol");
			attr(div9, "class", "note svelte-17sfzol");
...
class DLDToggles extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { data: 0 }, add_css$2);
	}
}
...
/* src\settings\FishtopiaToggles.svelte generated by Svelte v4.2.18 */

function add_css$1(target) {
	append_styles(target, "svelte-14u31wa", ".row.svelte-14u31wa{display:flex;align-items:center;gap:10px}input.svelte-14u31wa{width:20px;height:20px}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "row svelte-14u31wa");
			attr(input0, "type", "checkbox");
			attr(input0, "class", "svelte-14u31wa");
			attr(div1, "class", "row svelte-14u31wa");
			attr(input1, "type", "checkbox");
			attr(input1, "class", "svelte-14u31wa");
			attr(div2, "class", "row svelte-14u31wa");
			attr(input2, "type", "checkbox");
			attr(input2, "class", "svelte-14u31wa");
			attr(div3, "class", "row svelte-14u31wa");
			attr(input3, "type", "checkbox");
			attr(input3, "class", "svelte-14u31wa");
			attr(div4, "class", "row svelte-14u31wa");
			attr(input4, "type", "checkbox");
			attr(input4, "class", "svelte-14u31wa");
			attr(div5, "class", "row svelte-14u31wa");
		},
		m(target, anchor) {
			insert(target, div0, anchor);
			append(div0, select);
...
class FishtopiaToggles extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { data: 0 }, add_css$1);
	}
}
...
function create_fragment$1(ctx) {
	...
	fishtopiatoggles = new FishtopiaToggles({ props: { data: /*data*/ ctx[0] } });
