...
function add_css$2(target) {
	append_styles(target, "svelte-1jufc9h", ".row.svelte-1jufc9h{display:flex;align-items:center;gap:10px}input.svelte-1jufc9h{width:20px;height:20px}.note.svelte-1jufc9h{font-size:0.7em;color:gray}.error.svelte-1jufc9h{color:red}");
}
...
function create_fragment$4(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "row svelte-1jufc9h");
			attr(input0, "type", "checkbox");
			attr(input0, "class", "svelte-1jufc9h");
			attr(div1, "class", "row svelte-1jufc9h");
			attr(input1, "type", "checkbox");
			attr(input1, "class", "svelte-1jufc9h");
			attr(div2, "class", "row svelte-1jufc9h");
			attr(input2, "type", "checkbox");
			attr(input2, "class", "svelte-1jufc9h");
			attr(div3, "class", "row svelte-1jufc9h");
			attr(input3, "type", "checkbox");
			attr(input3, "class", "svelte-1jufc9h");
			attr(div4, "class", "row svelte-1jufc9h");
...
function add_css$1(target) {
	append_styles(target, "svelte-1kifeye", ".row.svelte-1kifeye{display:flex;align-items:center;gap:10px}input.svelte-1kifeye{width:20px;height:20px}");
}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "row svelte-1kifeye");
			attr(input0, "type", "checkbox");
			attr(input0, "class", "svelte-1kifeye");
			attr(div1, "class", "row svelte-1kifeye");
			attr(input1, "type", "checkbox");
			attr(input1, "class", "svelte-1kifeye");
			attr(div2, "class", "row svelte-1kifeye");
			attr(input2, "type", "checkbox");
			attr(input2, "class", "svelte-1kifeye");
			attr(div3, "class", "row svelte-1kifeye");
			attr(input3, "type", "checkbox");
